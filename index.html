    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip" id="home"></a>
              <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-bar bar1"></span><span class="navbar-toggler-bar bar2"></span><span class="navbar-toggler-bar bar3"></span></button>
            </div>
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#about" id="ab"></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#skill" id="sk"></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#portfolio" id="port"></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#experience" id="xp"></a></li>
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#contact" id="cont"></a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a data-toggle="modal" data-target="#foto" ><img src="images/jeremy.jpg" alt="Image"/></a></div>          
          <div class="h2 title">Jeremy Torres Jiménez</div>
          <select name="langs" id="lang">
            <option value="es-ES" id="ES"></option>
            <option value="en-EN" id="EN"></option>
          </select><br><br><br>
          <p class="category text-white" id="profesion"></p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor" id="contactbtn"></a><a class="btn btn-primary" data-aos="zoom-in" data-aos-anchor="data-aos-anchor" id="download" onclick="downloadCV()"></a>
        </div>
      </div>
      <div class="section">
        <div class="container">
          <div class="button-container">
          <a class="btn btn-git btn-round btn-lg btn-icon" href="https://github.com/Macho96" rel="tooltip" id="tGit" title=""><i class="fa fa-github"></i></a>
          <a class="btn btn-linkedin btn-round btn-lg btn-icon" href="https://www.linkedin.com/in/jeremy-torres-jim%C3%A9nez-26638821a/" rel="tooltip" id="tLink" title=""><i class="fa fa-linkedin" ></i></a>
          <a class="btn btn-insta btn-round btn-lg btn-icon" href="https://www.instagram.com/_macho_96/" rel="tooltip" id="tInsta" title=""><i class="fa fa-instagram"></i></a>
        </div>
        </div>
      </div>
    </div>
    ...
    <div class="card" data-aos="fade-up" data-aos-offset="10">
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title" id="tAbout"></div>
            <p id="aboutText"></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title" id="tInfo"></div>
            <div class="row">
              <div class="col-sm-4"><strong class="text-uppercase" id="age"></strong></div>
              <div class="col-sm-8">26</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase" id="email"></strong></div>
              <div class="col-sm-8">jeremyantoji@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase" id="phone"></strong></div>
              <div class="col-sm-8">61970128</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase" id="address"></strong></div>
              <div class="col-sm-8">Geranios, Guácimo, Limón</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase" id="lan"></strong></div>
              <div class="col-sm-8" id="languageKnow"></div>
            </div>
          </div>
        </div>
      </div>
...
<div class="section" id="skill">
  <div class="container">
    <div class="h4 text-center mb-4 title" id="tSkill"></div>
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-html5"></i><span class="progress-badge"> HTML</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-css3"></i><span class="progress-badge"> CSS</span>
              <div class="progress">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-js-square"></i><span class="progress-badge"> JavaScript/TypeScript</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-java"></i><span class="progress-badge"> Java</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fas fa-bold"></i> <span class="progress-badge"> Bootstrap</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-python"></i><span class="progress-badge">Python</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div><span class="progress-value">80%</span>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">C#/.net</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-php"></i><span class="progress-badge">PHP</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fas fa-cubes"></i><span class="progress-badge">VBA/VB</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
  ...
  <!--frameworks--> 
  <div class="container">
    <div class="h4 text-center mb-4 title" id="tFramework"></div>
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-angular"></i><span class="progress-badge">Angular</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 85%;"></div><span class="progress-value">85%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-react"></i><span class="progress-badge">React</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">MVC(netcore)</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><i class="fab fa-node"></i><span class="progress-badge">Node</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content modal-foto">
            ...
            <div class="modal-body">
              <img src="images/jeremy.jpg" alt="Image"/>
            </div>
...
<!-- Modal -->
    <footer class="footer">
      <div class="h4 title text-center">JEREMY TORRES CV PAGE</div>
    </footer>
